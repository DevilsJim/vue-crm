    ...
    <el-form :inline="true" :model="formInline">
      ...
      <el-form-item label="订单状态：">
        <el-select v-model="formInline.orderState" clearable>
          ...
          <el-option label="交易关闭(数据来源官网)" value="2" />
          <el-option label="服务关闭(数据来源于业务系统)" value="3" />
          <!-- <el-option label="服务半闭需要对接业务系统" value="4" /> -->
        </el-select>
      </el-form-item>
      <!-- 提交时间 -->
      ...
      <el-form-item label="合同类型：">
        <el-select v-model="formInline.contractType" clearable>
          <el-option label="全部" value="0" />
          <el-option label="非标合同" value="1" />
          <el-option label="标准合同" value="2" />
        </el-select>
      </el-form-item>
      <!-- 支付方式 -->
