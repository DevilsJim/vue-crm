<template>
  <el-dialog title="分配顾问" :close-on-click-modal="flag" :visible.sync="templateDialog" width="600px" @close="closeDia">
...
<script>
import { getSysUserPageList, collectCompanyToOther } from 'api/teamMeagement'
