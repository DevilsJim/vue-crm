  ...
  <div class="app-container customer-detail">
    ...
    <el-container height="auto" direction="horizontal">
      ...
      <div style="width: 50%; text-align: right; padding-top: 20px;" class="con-right">
        <el-button v-if="leader.createUserName !== null" type="primary" size="small" @click="handleChangeCustomer(companyInfo.companyId)">变更</el-button>
        <el-button v-else type="primary" size="small" @click="handleAssignAdvisor(companyInfo.companyId)">分配</el-button>
...
import { getDeptTreeList, getCurrentUserDeptUsers } from 'api/teamMeagement'
